# Car Shopping Workflow Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Write the `workflows/car-shopping.md` plain-English recipe that guides an agent through finding and shortlisting dealer car listings based on user criteria.

**Architecture:** Single workflow file following the established pattern in `workflows/research-report.md` — numbered steps with clear instructions, inline format templates, and a save-to-output convention.

**Tech Stack:** Markdown, web search tools (WebSearch), file write tools
...
|--------|------|----------------|
| Overwrite | `workflows/car-shopping.md` | The complete car shopping workflow recipe |
...
**Files:**
- Overwrite: `workflows/car-shopping.md`

- [ ] **Step 1: Read the existing file to understand current state**

Run: Read `workflows/car-shopping.md`

Note: The file currently contains a copy of the research report template — it will be fully replaced.

- [ ] **Step 2: Write the complete workflow file**

Write the following content to `workflows/car-shopping.md`:
...
Check each spec section against the written file:
- [ ] Step 1 collects all 6 required intake fields
- [ ] Step 2 searches CarGurus, Cars.com, Autotrader (no Facebook Marketplace)
- [ ] Step 2 collects all 7 listing fields (title, price, mileage, year, location, URL, date)
- [ ] Step 3 drops private sellers explicitly
- [ ] Step 4 uses 15% threshold for OVERPRICED and UNDERPRICED
- [ ] Step 5 includes all 5 flags with correct thresholds (15k miles/year, 60 days)
- [ ] Step 6 output format matches spec (table + notes section)
- [ ] Step 6 sort order: fewest flags first, then price ascending
- [ ] Output saved to `output/car-search-[YYYY-MM-DD].md`

- [ ] **Step 4: Commit**

```bash
git add workflows/car-shopping.md
git commit -m "feat: add car shopping workflow"
```
